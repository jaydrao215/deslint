...
[![CI](https://github.com/jaydrao215/vizlint/actions/workflows/ci.yml/badge.svg)](https://github.com/jaydrao215/vizlint/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)

**ESLint catches code bugs. Vizlint catches design bugs.**

Vizlint is the design quality gate for AI-generated frontend code. It catches spacing inconsistencies, typography drift, arbitrary colors, missing responsive breakpoints, accessibility issues, and inline style violations — in code generated by Claude Code, Cursor, v0, Bolt, Lovable, or any AI coding tool.
...
Vizlint computes a 0-100 Design Health Score across categories:
...
| [`@vizlint/action`](./action) | GitHub Action for PR design reviews |

## MCP Server (AI Self-Correction)

Vizlint includes an MCP server that enables AI coding tools to self-correct design violations:
...
```yaml
- uses: jaydrao215/vizlint/action@main
  with:
    min-score: 80
```
