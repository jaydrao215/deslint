...
**Auto-fix coverage:** 14 of 42 rules auto-correct in place (the rest report only — adding a responsive breakpoint, naming a design token, or moving a secret to a secret manager is a human decision).
