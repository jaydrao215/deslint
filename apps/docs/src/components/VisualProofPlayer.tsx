...
/**
 * Standalone visual-proof player used on the /proof page. Same four
 * beats + autoplay state machine as the original homepage section; the
 * surrounding hero and intro are owned by the host page, so this
 * component focuses on the carousel + recorded-loop block.
 */
export function VisualProofPlayer() {
  ...
  return (
    <section
      ref={sectionRef}
      id="visual-proof"
      className="relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white px-6 py-16"
    >
