...
const FOOTER_LINKS: Record<string, FooterLink[]> = {
  ...
  Resources: [
    ...
    { label: 'GitHub', href: 'https://github.com/deslint/deslint', external: true },
    { label: 'npm', href: 'https://www.npmjs.com/package/@deslint/eslint-plugin', external: true },
  ],
  Community: [
    { label: 'Twitter / X', href: 'https://x.com/deslint', external: true },
    { label: 'Discussions', href: 'https://github.com/deslint/deslint/discussions', external: true },
    { label: 'Report Issue', href: 'https://github.com/deslint/deslint/issues', external: true },
  ],
};
