export default function GettingStarted() {
  return (
    <div>
      ...
      <p>Add Deslint to your <code>eslint.config.js</code> (ESLint v10+ flat config):</p>
      <pre className="bg-gray-900 text-gray-100 rounded-lg p-4 overflow-x-auto">
...
export default [
  ...
  // ... your other config
      ...
      <p>
        ...
        a <code>.deslintrc.json</code> with your design system tokens.
      </p>
...
npx deslint fix --dry-run`}</code>
  ...
  run: npx deslint scan --min-score 75 --format sarif`}</code>
      ...
      <p>Deslint works with all major frontend frameworks out of the box:</p>
      <ul>
