      ...
      <div className="flex pt-14">
        ...
        <main className="flex-1 md:ml-64">
          <div className="mx-auto max-w-3xl px-6 sm:px-8 py-10">
            <article className="prose prose-gray max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-gray-900 prose-h1:text-3xl prose-h1:mb-4 prose-h2:text-xl prose-h2:mt-10 prose-h2:mb-4 prose-h2:pb-2 prose-h2:border-b prose-h2:border-gray-100 prose-h3:text-lg prose-h3:mt-8 prose-h2:scroll-mt-20 prose-h3:scroll-mt-20 prose-p:text-gray-600 prose-p:leading-relaxed prose-code:text-primary prose-code:bg-primary-50/50 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md prose-code:text-[13px] prose-code:font-medium prose-code:before:content-none prose-code:after:content-none prose-pre:bg-gray-950 prose-pre:border prose-pre:border-gray-800/50 prose-pre:rounded-xl prose-pre:text-[13px] prose-pre:text-gray-100 prose-pre:leading-relaxed [&_pre_code]:!bg-transparent [&_pre_code]:!text-inherit [&_pre_code]:!p-0 [&_pre_code]:!font-normal [&_pre_code]:!rounded-none [&_pre_code]:font-mono prose-strong:text-gray-900 prose-li:text-gray-600 prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
              {children}
            </article>
          </div>
        </main>
