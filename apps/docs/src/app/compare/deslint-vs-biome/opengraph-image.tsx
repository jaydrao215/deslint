...
export const alt =
  'Deslint vs. Biome — design lint on top of the all-in-one toolchain. Biome handles formatting and JS correctness; Deslint adds design tokens, Tailwind drift, WCAG, and AI-agent integration.';

// Comparison-page OG. Frame: "Speed + Intent" — Biome wins on speed and
// general JS lint, Deslint wins on design intent. Two product chips
// with a "+" between, verdict line below. Same visual stack as the
// other comparison OGs so the brand reads consistently.
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, marginTop: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            <ProductChip name="Biome" accent="#60A5FA" sub="Format · JS lint · speed" />
          ...
          <div style={{ display: 'flex', marginTop: '20px', fontSize: '19px', lineHeight: 1.5, color: 'rgba(250,250,251,0.65)', maxWidth: '760px', textAlign: 'center', justifyContent: 'center' }}>
            Biome formats and lints JavaScript in milliseconds. Deslint adds 37 deterministic rules for design tokens, Tailwind drift, WCAG 2.2, and AI-agent integration on top.
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '32px' }}>
          <div style={{ display: 'flex', fontSize: '14px', color: 'rgba(250,250,251,0.45)' }}>
            Side-by-side on six real questions — speed, JS lint, Tailwind, tokens, WCAG, AI agents.
          </div>
