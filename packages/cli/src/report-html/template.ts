    ...
    : `<table class="tbl">
      ...
      <tbody>
        ${data.ruleSummaries.slice(0, 15).map(r => `<tr>
          ...
          <td style="text-align:right"><a href="https://deslint.com/docs/rules#${esc(r.shortName)}" target="_blank" rel="noopener noreferrer">View rule &rarr;</a></td>
        </tr>`).join('')}
      </tbody>
    </table>
    ...
    <div class="v-list" id="v-list">
      ${violationsByFile.map(g => `<div class="v-file-group">
        ...
        ${g.items.map(v => {
          ...
          <a class="v-rule-link" href="https://deslint.com/docs/rules#${esc(short)}" target="_blank" rel="noopener noreferrer">${esc(short)} &rarr;</a>
        </div>`;
        }).join('')}
      </div>`).join('')}
    </div>
...
<footer class="footer">
  Generated by <a href="https://deslint.com" target="_blank" rel="noopener noreferrer">Deslint v${esc(data.version)}</a>
  &nbsp;·&nbsp; Scanned ${esc(timestamp)}
  &nbsp;·&nbsp; ${data.summary.totalFiles} file${data.summary.totalFiles === 1 ? '' : 's'} (${fileCoverage}% with issues)
  &nbsp;·&nbsp; <a href="https://deslint.com/docs/rules" target="_blank" rel="noopener noreferrer">Rules documentation</a>
</footer>
    ...
    moreBtn.addEventListener('click', function () {
      ...
      PENDING.forEach(function (v) {
        ...
        d.innerHTML =
          ...
          '</div>' +
          '<a class="v-rule-link" href="https://deslint.com/docs/rules#' + escHtml(short) + '" target="_blank" rel="noopener noreferrer">' + escHtml(short) + ' &rarr;</a>';
        g.appendChild(d);
      });
      list.appendChild(g);
      moreBtn.remove();
